...
<div class="form-group">
  ...
  <div class="col-md-4">
    <input class="form-control datepicker pick due-date-individual" id="due_date[]" style="width:101%;margin-left: -60%" name="due_date[]" value="<?php echo $_POST['due_date'] ?>" type="text" readonly>
  </div>
</div>
