...
<form onsubmit="return proceed();" name="Form" id="Form" class="form-horizontal" method="post" action="search_user.php" enctype="multipart/form-data">
<fieldset>
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="name" name="name" value="<?php echo $arr_search['response'][0]['user_details']['uid'] ?>" type="text" placeholder="" class="form-control input-md" readonly>
