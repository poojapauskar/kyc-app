...
<!--date-->
<div class="form-group">
  <label for="example-date-input" class="col-md-4 col-label">DATE:</label>
  <div class="col-md-4">
    <input class="form-control datepicker pick" id="date[]" name="date[]" value="<?php echo $_POST['date'] ?>" type="text" readonly>
  </div>
</div>
