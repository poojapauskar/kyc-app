...
<div class="form-group">
 ...
 <div class="row">
  <div class="col-md-4 col-lg-6 ">
    ...
    <button id="singlebutton" style="width: 10em;margin-left: 2%;" name="singlebutton" class="btn btn-primary"><a style="color:white" onclick="location.href="search.php">Discard</a></button>
...
<div class="form-group">
 ...
 <div class="row">
  <div class="col-md-4 col-lg-6">
    ...
    <button id="singlebutton" name="singlebutton" class="btn btn-primary" style="width: 10em;margin-left: 2%;"><a style="color:white" href="search.php">Discard</a>
    </button>
  </div>
  </div>
  </div>
