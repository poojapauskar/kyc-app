...
<div class="form-group">
  ...
  <input id="partner_names[]" name="partner_names[]" type="text" placeholder="Enter Full Name" class="form-control input-md newentry partner_names instantsearch" style="width: 80% !important">
  </div>
...
<!--date __Individual page___-->
<div class="form-group">
  <label for="example-date-input" class="col-md-1 col-label date-label-individual" style="">DUE DATE:</label>
  <div class="col-md-4">
