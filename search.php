...
$db = pg_connect("host=ec2-54-243-252-91.compute-1.amazonaws.com port=5432 dbname=d9nk0o0a44u59m user=iqoiktexvcnwkp password=dcaaf938958ac73448ca87856def466bb40e37047113e8191dacb20f8d87b21d");
 ...
 $query=pg_query("(SELECT id,name,is_user,account_token,is_active FROM organization_organization WHERE is_active = 1 AND account_token = '".$_SESSION['account_token']."')
  UNION 
 (SELECT id,name,is_user,account_token,is_active FROM users_users WHERE is_active = 1 AND account_token = '".$_SESSION['account_token']."')");
